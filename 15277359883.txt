...
CreateToggle("Auto Farm Logs", "Whitelist + 0.01s Hit", function(v) _G.AutoFarm = v end)
CreateToggle("Auto Collect Logs", "Instantâneo (Sem Delay)", function(v) _G.AutoCollect = v end)
CreateToggle("Auto Sell", "Teleporte e Venda", function(v) _G.AutoSell = v end)
